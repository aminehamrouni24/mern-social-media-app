...
router.get('/current', passport.authenticate('jwt',{session:false}), profileController.profileCurrent)
...
//@desc in profileController.js
router.get('/handle/:handle', passport.authenticate('jwt',{session:false}), profileController.profileHandle)
...
//get all profiles
//@desc in profileController.js
router.get('/all', passport.authenticate('jwt',{session:false}), profileController.getAllProfiles)
